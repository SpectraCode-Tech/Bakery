  ...
  return (
    <section className='h-screen p-10 bg-cover bg-center bg-no-repeat' style={{backgroundImage: `url(${heroImg})`}}>
      <div className='flex flex-col h-screen w-full sm:w-3/5 justify-center justify-items-center space-y-10'>
        ...
        <button className='bg-light ease-in-out tracking-widest transition duration-200 self-start font-Montserrat hover:bg-accent active:bg-accent/70 cursor-pointer text-white font-bold py-2 px-4 rounded-full'>Request a Cake</button>
      </div>
    </section>
  )
}
